...
class MainActivity : android.support.v7.app.AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: android.os.Bundle?) {
        ...
        setContentView(com.example.tictactoeonline.R.layout.activity_main)
    ...
    protected  fun buClick(view: android.view.View){
        ...
        var cellID=0
        when(buSelected.id){
            com.example.tictactoeonline.R.id.bu1-> cellID=1
            com.example.tictactoeonline.R.id.bu2-> cellID=2
            com.example.tictactoeonline.R.id.bu3-> cellID=3
            com.example.tictactoeonline.R.id.bu4-> cellID=4
            com.example.tictactoeonline.R.id.bu5-> cellID=5
            com.example.tictactoeonline.R.id.bu6-> cellID=6
            com.example.tictactoeonline.R.id.bu7-> cellID=7
            com.example.tictactoeonline.R.id.bu8-> cellID=8
            com.example.tictactoeonline.R.id.bu9-> cellID=9
